...
function capicua(numero) {
  ...
  let numberToStringReversed = numberToString.split("").reverse().join("");

  return numberToString === numberToStringReversed
    ? "Es capicua"
    : "No es capicua";
}
...
function sortArray(arr) {
  ...
  let arraySorted = arr.sort((a, b) => a.length - b.length);
